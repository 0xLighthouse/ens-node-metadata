...
To find the all users who who have registered their forum username we could index the `forum-handle[ens.eth]` text record.
...
Regardless of the approach the ENS remains the cannoncial source.

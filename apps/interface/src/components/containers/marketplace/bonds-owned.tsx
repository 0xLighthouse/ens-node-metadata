...
export const BondsOwned = () => {
  ...
  // If we are not connected, show alternative state
  if (!address) {
    return (
      <ListContainer title="Compatible Bonds">
        <PageSection>
          <div className="text-center py-8">
            <h3 className="text-lg font-medium mb-2">Wallet not connected</h3>
            <p className="text-neutral-500 dark:text-neutral-400">
              Connect your wallet to view your tradable positions.
            </p>
          </div>
        </PageSection>
        <InformationSection />
  ...
  if (bonds.length === 0) {
    return (
      <ListContainer title="Bonds" count={bonds.length}>
        <PageSection>
          <div className="text-center py-8">
            <h3 className="text-lg font-medium mb-2">No positions found</h3>
            <p className="text-neutral-500 dark:text-neutral-400">
              Compatible bonds in your wallet will appear here.
            </p>
          </div>
        </PageSection>
        <InformationSection />
